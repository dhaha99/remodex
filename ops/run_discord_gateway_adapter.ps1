...
if (-not $env:REMODEX_DISCORD_GATEWAY_INTENTS) { $env:REMODEX_DISCORD_GATEWAY_INTENTS = "33281" }
if (-not $env:REMODEX_DISCORD_API_BASE_URL) { $env:REMODEX_DISCORD_API_BASE_URL = "https://discord.com/api/v10" }
if (-not $env:REMODEX_DISCORD_OUTBOX_POLL_INTERVAL_MS) { $env:REMODEX_DISCORD_OUTBOX_POLL_INTERVAL_MS = "2000" }
